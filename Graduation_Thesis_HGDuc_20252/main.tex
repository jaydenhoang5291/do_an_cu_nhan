...
\setcounter{figure}{0}
\setcounter{table}{0}
\input{body/chap2-theoretical_background}
\pagebreak

\section*{CHAPTER 3. SYSTEM DESIGN}
\addcontentsline{toc}{section}{\protect\numberline{}CHAPTER 3. SYSTEM DESIGN}
\setcounter{section}{3}
\setcounter{subsection}{0}
\setcounter{figure}{0}
\setcounter{table}{0}
\input{body/chap3-system_design}
\pagebreak 
...
\setcounter{figure}{0}
\setcounter{table}{0}
\input{body/chap4-experimental_results}
\pagebreak 
