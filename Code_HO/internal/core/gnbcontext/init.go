...
var HoEventHandler func(prUeId int64, eventType model.EventType, data interface{})

func SendHoEvent(prUeId int64, eventType model.EventType, data interface{}) {
	if HoEventHandler != nil {
		HoEventHandler(prUeId, eventType, data)
	}
}
