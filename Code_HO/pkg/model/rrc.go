...
const (
	...
	// CHO (Conditional Handover) message types
	MeasurementReportType          string = "MeasurementReport message"
	CHOConfigType                  string = "CHOConfig message"
	RRCReconfigurationCompleteType string = "RRCReconfigurationComplete message"
	CHOExecuteNotificationType     string = "CHOExecuteNotification message"
	ConditionalHandoverCancelType  string = "ConditionalHandoverCancel message"
)
...
// CHO (Conditional Handover) message GetType() implementations

func (m *MeasurementReport) GetType() string {
	return MeasurementReportType
}

func (m *CHOConfig) GetType() string {
	return CHOConfigType
}

func (m *RRCReconfigurationComplete) GetType() string {
	return RRCReconfigurationCompleteType
}

func (m *CHOExecuteNotification) GetType() string {
	return CHOExecuteNotificationType
}

func (m *ConditionalHandoverCancel) GetType() string {
	return ConditionalHandoverCancelType
}
