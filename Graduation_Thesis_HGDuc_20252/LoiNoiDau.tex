...
For that reason, this graduation thesis was developed to build a simulation-based radio-data generation workflow and a log-based handover-delay analysis workflow for studying 5G mobility. The work focuses on generating structured radio-measurement data and examining handover delay from timer-event logs under different configuration and network-condition settings.
